...
`userpower_level_names` varchar(16) NOT NULL,
`userpower_level_power` int(2) NOT NULL,
`userpower_position` varchar(24) NOT NULL,
...
if(!empty($adminUser)){$this->eBAdminUserIsSet = $adminUser;}
