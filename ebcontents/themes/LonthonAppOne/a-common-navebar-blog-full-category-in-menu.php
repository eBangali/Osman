...
<li class='dropdown'> <a href='<?php echo outContentsLink; ?>/contents/' class='dropdown-toggle' data-toggle='dropdown'> <?php echo $category->visulString($contents_category); ?> <b class='caret'></b></a>
...
<li><a href='<?php echo outContentsLink; ?>/contents/category/<?php echo $contents_id; ?>/' title='<?php echo $contents_sub_category; ?>'><?php echo $subcategory->visulString($contents_sub_category); ?></a></li>
<?php } ?>
<?php endforeach; } ?>
</ul>
</li>
