...
<link rel='stylesheet' type='text/css' href='<?php echo themeResource; ?>/css/morris.css'>
<script src='<?php echo themeResource; ?>/js/jquery.min.js'></script>
<script src='<?php echo themeResource; ?>/js/raphael-min.js'></script>
<script src='<?php echo themeResource; ?>/js/morris.min.js'></script>
