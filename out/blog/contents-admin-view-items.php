...
$contentviewitems .= "<b>Title: $contents_og_image_title</b><br>";
...
$contentviewitems .="<div class='row'><div class='col-xs-12 col-md-3'>Title:</div><div class='col-xs-12 col-md-9'>$contents_og_image_title</div></div>";
...
$contentviewitems .="<div class='row'><div class='col-xs-12 col-md-3'>What to do:</div><div class='col-xs-12 col-md-9'>$contents_og_image_what_to_do</div></div>";
if(!empty($contents_og_image_how_to_solve))
{
$contentviewitems .="<div class='row'><div class='col-xs-12 col-md-3'>How to do:</div><div class='col-xs-12 col-md-9'>$contents_og_image_how_to_solve</div></div>";
}
...
if($contents_approved != 'OK' and !empty($contents_og_image_url))
{
