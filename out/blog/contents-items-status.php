...
if($contents_approved=='GPOST'){
$solutionStatus .= "<i class='fa fa-check-circle fa-lg' aria-hidden='true'></i> PUBLISHED <br>";
}
$solutionStatus .= "<b>Title: $contents_og_image_title</b><br>";
...
//
$solutionStatus .= "<div class='row'><div class='col-xs-12 col-md-3'>Title:</div><div class='col-xs-12 col-md-9'>$contents_og_image_title</div></div>";
...
$solutionStatus .= "<div class='row'><div class='col-xs-12 col-md-3'>Profile Image:</div><div class='col-xs-12 col-md-9'><form action='contents-image-upload-croper.php' method='post'><input type='hidden' name='contents_id' value='$contents_id' /><div class='buttons-set'>
...
$solutionStatus .= "<div class='row'><div class='col-xs-12 col-md-3'>What to do:</div><div class='col-xs-12 col-md-9'>$contents_og_image_what_to_do</div></div>";
$solutionStatus .= "<div class='row'><div class='col-xs-12 col-md-3'>How to do:</div><div class='col-xs-12 col-md-9'>$contents_og_image_how_to_solve</div></div>";
