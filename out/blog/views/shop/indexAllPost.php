...
$postArticle .="'><img class='img-responsive' alt='".$contents_og_image_title."' src='";
...
$postArticle .="</ul>";
$postArticle .="<div>";
$postArticle .=$contents_og_image_what_to_do;
$postArticle .="</div>";
$postArticle .="</div>";
...
$postArticle .="'>".$objPost->visulString($contents_category)."</a> and <a title='View all posts in ".$contents_sub_category."' href='";
