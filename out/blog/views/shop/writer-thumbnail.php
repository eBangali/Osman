...
$wRiter -> contents_thurmnail_group($contentsbloggroup);
if($wRiter->eBData)
{
...
$newSearch .="<h2>".$wRiter->visulString($contentsbloggroup)."</h2>";
$newSearch .="</div>";
$newSearch .="</li>";
$newSearch .="</ul>";
$newSearch .="</div>";
...
$newSearch .="<div class='item-title'><h3>".strtoupper($wRiter->visulString($contents_category))."</h3></div>";
...
$newSearch .=outContentsLink."/contents/solve/$contents_id/".$wRiter->seoUrl($contents_og_image_title)."/";
