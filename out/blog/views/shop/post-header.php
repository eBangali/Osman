...
$objPost = new ebapps\blog\blog(); $objPost -> contents_detail_all_part($articleno);
...
$postArticle .="<h1 title='".$contents_og_image_title."' class='blog_entry-title'>";
...
$postArticle .="<img class='img-responsive' title='".$contents_og_image_title."' alt='".$contents_og_image_title."' src='";
