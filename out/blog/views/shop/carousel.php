...
<li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?php echo hypertextWithOrWithoutWww.$contents_og_image_url; ?>'><img src='<?php echo hypertextWithOrWithoutWww.$contents_og_image_url; ?>' alt='<?php echo $contents_og_image_title; ?>' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' />
<div class='info'>
