...
<div class="well">
<button onclick='PrintDocInvoicMarcent();' class='button submit'><b>Click to Print</b></button>
<script type='text/javascript'>
function PrintDocInvoicMarcent()
{
var toPrint = document.getElementById('selectPrintArea');
...
<?php
$invoice = "<div id='selectPrintArea'>";
...
?>
<?php $objBuyerContact = new ebapps\bay\ebcart(); $objBuyerContact -> merchant_view_invoice_buyer_contact_details(); ?>
<?php if($objBuyerContact->eBData){ foreach($objBuyerContact->eBData as $val): extract($val); ?>
<?php $objdate = new ebapps\bay\ebcart(); $objdate -> merchant_view_invoice_date_invoice_num(); ?>
<?php if($objdate->eBData){ foreach($objdate->eBData as $val): extract($val); ?>
<?php $objInvoceNo = new ebapps\bay\ebcart(); $objInvoceNo -> merchant_view_invoice_date_invoice_num(); ?>
<?php if($objInvoceNo->eBData){ foreach($objInvoceNo->eBData as $val): extract($val); ?>
<?php
$qrurl = outBayLinkFull."/merchant-view-invoice.php?trackerID=$tracking_unique_sales_order_io";
...
$invoice .= "</div>";
?>
<?php $objShipTo = new ebapps\bay\ebcart(); $objShipTo -> merchant_view_invoice_shipment_to(); ?>
...
$invoice .= "<tbody>";
?>
<?php $objProdect = new ebapps\bay\ebcart(); $objProdect -> merchant_view_invoice(); ?>
...
?>
<?php $objThurmbnail = new ebapps\bay\ebcart(); $objThurmbnail -> merchant_view_invoice_product_sml_image($bay_showroom_approved_items_id_io); ?>
...
?>
<?php $obj = new ebapps\bay\ebcart(); $obj -> merchant_view_invoice_sum_of_vat_shipment_total(); ?>
