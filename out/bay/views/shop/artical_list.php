...
$gridInfo .=outBayLink."/product/grid/$bay_showroom_approved_items_id/";
}
}
$gridInfo .="'>&nbsp;</a>";
...
$gridInfo .="<a href='";
$gridInfo .=outBayLink."/product/item-details-list/$bay_showroom_approved_items_id/";
...
$gridInfo .="<p>".stripslashes($s_og_image_description)."</p> ";
$gridInfo .="</div>";
