...
$newProduct .="<li class='item col-sm-2 col-xs-12'>";
...
if($s_size != 'NA')
{
$newProduct .=$this->visulString($s_size);
}
if($salse > 0)
{
$newProduct .=" ($salse)";
...
echo $obj -> bayProductPaginationBestSales();
?>