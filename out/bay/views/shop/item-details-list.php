...
<?php include_once (eblayout.'/a-common-share-button-for-bay.php'); ?>
<?php include_once ('breadcrumbs-list.php'); ?>
<?php include_once ('search.php'); ?>
<?php include_once (eblayout."/a-common-ad-body.php"); ?>
<?php include_once ('item-cart-only.php'); ?>
<!-- Best Sales Compare Chouse one of them -->
<?php //include_once("item-thurmnai-category-c-ux-one.php"); ?>
<?php include_once ("item-thurmnai-category-c-ux-one_per_6.php"); ?>
<!-- New Arrival Chouse one of them -->
<?php //include_once("item-thurmnai-category-c-new-ux-one.php"); ?>
<?php include_once ("item-thurmnai-category-c-new-ux-one_per_6.php"); ?>
