...
?>
<form method='post' action='<?php echo outBayLink; ?>/product/selectiongrid/<?php echo $bay_showroom_approved_items_id; ?>/<?php echo $this->seoUrl($s_category_a); ?>/<?php echo $this->seoUrl($s_category_b); ?>/<?php echo $this->seoUrl($s_category_c); ?>/<?php echo $this->seoUrl($s_category_d); ?>/'>
<?php }} ?>
