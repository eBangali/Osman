...
$subCategoryDiscountMax ->maxDiscountABCDID(); 
...
$maxiDiscount .="<h2>All Product</h2>";
$maxiDiscount .="</div>";
$maxiDiscount .="</li>";
$maxiDiscount .="</ul>";
$maxiDiscount .="</div>";
...
$maxiDiscount .="<li class='item col-sm-2 col-xs-12'>";
...
if($s_size != 'NA')
{
$maxiDiscount .=$subCategoryDiscountMax->visulString($s_size);
}
if($salse > 0)
{
$maxiDiscount .=" ($salse)";
...
echo $obj -> bayProductPaginationMaxDis();
?>