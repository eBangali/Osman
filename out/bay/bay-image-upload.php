...
<?php include_once (ebimageupload.'/uploadimage-bay.php'); ?>
<?php
if(isset($_REQUEST['submit']))
{
extract($_REQUEST);
//
$merchant_small = new ebapps\bay\ebcart();
$up = new ebapps\upload\uploadimage();
$url_raw_small = $up -> upload_file_small('item_picture');
$bay_mer_og_small_image_url = str_replace(docRoot, domainForImagStore, $url_raw_small);
$merchant_small->updates_bay_small_image_url($bay_merchant_add_items_id,$bay_mer_og_small_image_url);
//
...
$merchant->updates_merchant_image_url($bay_merchant_add_items_id,$m_url);
}
}
?>
<?php $merchant = new ebapps\bay\ebcart(); $merchant -> upload_image_to_bay_merchant(); ?>
