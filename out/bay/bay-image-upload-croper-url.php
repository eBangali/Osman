...
$store_path_app = $store_path_1."/"."bay";
...
$imageName = $file_path;
$m_og_image_url = str_replace(docRoot, domainForImagStore, $imageName);
file_put_contents($imageName, $data);
//
$upload_path_small = $store_path_5;
$file_path_small = $upload_path_small.'/'.uniqid(mt_rand()).'.png';
$imageNameSmall = $file_path_small;
$m_og_small_image_url = str_replace(docRoot, domainForImagStore, $imageNameSmall);
file_put_contents($imageNameSmall, $data);
//
echo $imageName;
echo $imageNameSmall;
//
$bay_merchant_add_items_id = intval($_POST['bay_merchant_add_items_id']);
//
if(isset($_SESSION['memberlevel']))
{
if($_SESSION['memberlevel'] >= 8)
{
$query = "UPDATE bay_merchant_add_items set m_og_image_url='$m_og_image_url', m_og_small_image_url='$m_og_small_image_url' where bay_merchant_add_items_id=$bay_merchant_add_items_id";
