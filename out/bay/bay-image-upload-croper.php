      ...
      <div class='col-md-4'>
        <div class='image_area'>
          <form method='post'>
            ...
            <input type='hidden' id='bay_merchant_add_items_id' value='<?php echo $bay_merchant_add_items_id; ?>'>
...
var bay_merchant_add_items_id = document.getElementById('bay_merchant_add_items_id').value;
var cropper;
...
$.ajax({
url: "bay-image-upload-croper-url.php",
method: "POST",                	
data: {image: base64data, bay_merchant_add_items_id: bay_merchant_add_items_id},
