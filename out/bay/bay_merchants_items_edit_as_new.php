...
{
extract($_REQUEST);
$obj->merchant_product_update_as_new($m_category_a, $m_category_b, $m_category_c, $m_category_d, $bay_merchant_add_items_id, $uniqueProductID, $m_og_image_title, $m_og_image_description, $m_showroom_id, $m_size, $m_costprice_price, $m_stock, $m_profit_percent, $m_marked_price, $m_discount_percent, $m_vat_tax, $m_weight, $m_handling_packing, $m_video_link);
}
//
}
?>
...
$updateProduct .="</select></div>";
//
$updateProduct .="<div class='input-group'> <span class='input-group-addon'>Cost Price ".primaryCurrency." (1 ".primaryCurrency." = ".convertSecondary." ".secondaryCurrency."):</span> $m_costprice_price_error <input type='hidden' value='' id='costPriceShow'><input type='number' step='0.01' min='0.01' max='999999.99' name='m_costprice_price' id='costPrice' value='' placeholder='999999.99' required onchange='costPriceShowFunction(this.value);' class='form-control' aria-describedby='sizing-addon2' required autofocus /></div>";
$updateProduct .="<dt class='last even'>Profit Percent: $m_profit_percent_error <input type='button' id='profitShow' /></dt>";

$updateProduct .="<dd class='last even'><input type='range' name='m_profit_percent' id='profitPercent' min='0' max='499' onchange='profitPercentFunction(this.value);' required autofocus></dd";

$updateProduct .="<dt class='last even'>Discount Percent: $m_discount_percent_error<input type='button' id='discountShow' /></dt>";

$updateProduct .="<dd class='last even'><input type='range' name='m_discount_percent' id='discountPercent' step='0.01' min='0.00' max='89.99' onchange='discountFunction(this.value);' required autofocus></dd>";

$updateProduct .="<div class='input-group'> <span class='input-group-addon'>Marked Price $m_marked_price_error ".primaryCurrency." (1 ".primaryCurrency." = ".convertSecondary." ".secondaryCurrency."):</span><input class='form-control' min='0.00' type='number' step='0.01' max='99999999.99' name='m_marked_price' value='' id='markedPriceShow' placeholder='99999999.99' required /></div>";
